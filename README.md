# genpark-schema-enforced-structured-llm-extraction-validator-skill
...
> **GenPark AI Agent Skill** -- Schema-enforced structured LLM extraction engine with validation retries (Instructor style)
